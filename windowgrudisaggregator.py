...
from tensorflow.keras.layers import Attention,Conv1D,Dense,Embedding,Flatten,GlobalAveragePooling1D,GRU, Bidirectional,Dropout
...
class WindowGRUDisaggregator(Disaggregator):
    ...
    def train(self, mains, meter, epochs=1, batch_size=128, start=None, end=None, **load_kwargs):
        '''Train
